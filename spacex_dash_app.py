...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        grouped_df = data.groupby(['Launch Site', 'class']).size().reset_index(name='class count')
...
def get_scatter_chart(entered_site, payload):
    filtered_df = spacex_df.loc[(spacex_df["Payload Mass (kg)"] >= min(payload)) & 
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, 
                         ...
                         title='Total Launch Successes by Booster Version')
    else:
        ...
        fig = px.scatter(filtered_df, 
                         ...
                         y="class", 
                         color="Booster Version Category",
                         title=f'Total Launch Successes for {entered_site}')
    return fig
